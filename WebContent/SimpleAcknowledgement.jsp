...
%>
	...
	<h4>Thank You, ${name} for filling out the form</h4>
...
<ul>
 <% for(int i = 0; i < studentList.size(); i+=1) { %>
 	<li><button class="buttonlink buttonlink:hover" type = "submit" name="studentlinks" value="<%=studentList.get(i) %>"><%= studentList.get(i) %></button></li> 
 <%} %>
</ul>
</form>
</body>
